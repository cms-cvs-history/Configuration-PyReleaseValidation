...
workflows[4.43] = ['',['RunMu2012A','HLTD','RECODst3']]
workflows[4.44] = ['',['RunElectron2012A','HLTD','RECODst3']]
workflows[4.45] = ['',['RunJet2012A','HLTD','RECODst3']]
...
workflows[40.53] = ['',['RunHI2011','RECOHID11']]
