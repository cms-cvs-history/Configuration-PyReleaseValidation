...
step1Defaults = {'--relval'      : None, # need to be explicitly set
                 '-s'            : 'GEN,SIM',
                 '-n'            : 10,
                 '--conditions'  : 'auto:startup_7E33v2',
                 '--datatier'    : 'GEN-SIM',
                 '--eventcontent': 'RAWSIM',
                 }
...
stCond={'--conditions':'auto:startup_7E33v2'}
...
dataReco={'--conditions':'auto:com10_7E33v2',
...
steps['ALCACOSD']={'--conditions':'auto:com10_7E33v2',
                   '--datatier':'ALCARECO',
